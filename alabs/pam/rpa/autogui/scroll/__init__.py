...
def main(*args):
    ...
    if _platform == 'Linux':
        from alabs.pam.rpa.autogui.scroll.linux import main as _main

    elif _platform == 'Windows':
        from alabs.pam.rpa.autogui.scroll.linux import main as _main

    elif _platform == 'Darwin':
        from alabs.pam.rpa.autogui.scroll.macos import main as _main

    elif _platform == Platforms.IOS.value:
        from alabs.pam.rpa.autogui.scroll.ios import main as _main
