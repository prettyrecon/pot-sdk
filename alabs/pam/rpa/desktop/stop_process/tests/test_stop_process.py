...
from alabs.common.util.vvargs import ArgsError, ArgsExit, ModuleContext,\
    func_log, str2bool
from alabs.pam.rpa.desktop.stop_process import main as _main
from alabs.pam.rpa.desktop.execute_process import main as execute_process
...
class TU(TestCase):
    ...
    def test0020_stop_process_by_name(self):
        ...
        cmd = 'python -m alabs.pam.rpa.desktop.execute_process python -c "import time;time.sleep(5)"'
