...
def main(*args):
    ...
    if _platform == Platforms.LINUX.value:
        from alabs.rpa.autogui.find_image_location.linux import main as _main

    elif _platform == Platforms.MAC.value:
        from alabs.rpa.autogui.find_image_location.macos import main as _main

    elif _platform == Platforms.IOS.value:
        from alabs.rpa.autogui.find_image_location.ios import main as _main
